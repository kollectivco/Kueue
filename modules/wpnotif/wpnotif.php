...
final class WPNotif
{
    ...
    public function admin_notices()
    {
        if (!empty($_GET['page']) && $_GET['page'] == 'wpnotif-usergroups') {
            if (get_option('wpnotif_create_usergroup_notice', -1) != 1) {
                ...
                $notice_links = [
                        ['label' => __('Create Predefined Groups', 'wpnotif'), 'url' => $link],
                ];
                $notice_text = __('Please create predefined user groups. This is a one time process and new users will be added automatically.', 'wpnotif');
    ...
    public function getGateWayArray()
    {
        ...
        $whatsapp_gateway_inputs = array(
                ...
                array(
                        ...
                        'value' => 18,
                        'name' => 'bird_accesskey',
                        'show_if' => 'whatsapp_gateway_18',
                        'label' => esc_attr__('Bird Access Key'),
                ),
                array(
                        'text' => true,
                        'value' => 18,
                        'name' => 'bird_channel_id',
                        'show_if' => 'whatsapp_gateway_18',
                        'label' => esc_attr__('Bird Channel ID'),
                ),
                array(
                        'text' => true,
                        'value' => 18,
                        'name' => 'bird_workspace_id',
                        'show_if' => 'whatsapp_gateway_18',
                        'label' => esc_attr__('Bird Workspace ID'),
                ),
                array(
                        'text' => true,
                        'value' => 18,
                        'name' => 'bird_template_language',
                        'show_if' => 'whatsapp_gateway_18',
                        'label' => esc_attr__('Template Language'),
                        'optional' => 1,
                ),
                array(
                        'text' => true,
                        'value' => 18,
                        'name' => 'bird_project_id',
                        'show_if' => 'whatsapp_gateway_18',
                        'label' => esc_attr__('Bird Template Project ID (optional)'),
                        'optional' => 1,
                ),
        ...
        return array(
                ...
                'api' => array(
                        ...
                        'values' => array(
                                ...
                                esc_attr__('Bird', 'wpnotif') => array('value' => 18, 'require_addon' => 1, 'document_link' => true),
    ...
    public static function wpnotif_show_notice($notice, $links, $dismissible)
    {
        ...
        ?>
        <div class="wpnotif_admin_notice notice" style="display: flex !important;">
                                ...
                                <div class="unovr_test_number_wrapper">
                                    <div class="digcon">
                                        ...
                                        <input dig-save="0" class="mobile" type="text"
                                               ...
                                               name="mobile_email" style="padding-left:107px">
                                    </div>
    ...
    public function render_notifications_ui($admin_options, $admin_values, $suffix)
    {
        ...
        foreach ($admin_options as $key => $values) {
            ...
            $key = esc_html($key);
            ?>
            <table class="form-table form-switch <?php if(!empty($suffix)) echo 'wpnotif_nf_'.esc_attr($suffix);?>">
                <tr>
                            ...
                            <td>
                                <div class="position-relative">
                                                                    ...
                                                                    <textarea
                                                                            ...
                                                                            class="wpnotif_message_notification_textarea"
