        ...
        return array(
            ...
            'osonsms' => array(
                ...
                'inputs' => array(
                    ...
                    untdovr_gateway_field_label('Password Hash') => array('text' => true, 'name' => 'pass_hash'),
                    untdovr_gateway_field_label('From') => array('text' => true, 'name' => 'from'),
                ),
            ),
            'dooae' => array(
            ...
            'aliyun' => array(
                ...
                'inputs' =>
                    array(
                        untdovr_gateway_field_label('Access Key') => array('text' => true, 'name' => 'access_key'),
                        untdovr_gateway_field_label('Access Secret') => array('text' => true, 'name' => 'access_secret'),
                        untdovr_gateway_field_label('Region (Optional)') => array('text' => true, 'name' => 'region', 'optional' => 1),
                        untdovr_gateway_field_label('API Version (Optional)') => array('text' => true, 'name' => 'api_version', 'optional' => 1),
                    )
            ),
            ...
            'smsconnexion' => array(
                ...
                'inputs' =>
                    array(
                        untdovr_gateway_field_label('API Token') => array('text' => true, 'name' => 'access_token'),
                        untdovr_gateway_field_label('From') => array('text' => true, 'name' => 'from', 'optional' => 1),
                    )
            ),
            ...
            'smstoolssk' => array(
                'value' => 204,
                'require_addon' => 1,
                'label' => 'O2 - SMS Connector (smstools.sk)',
                'inputs' => array(
