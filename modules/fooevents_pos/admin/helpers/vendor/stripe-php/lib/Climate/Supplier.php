 ...
 * @property ((object{city: null|string, country: string, latitude: null|float, longitude: null|float, region: null|string}&\FooEventsPOS\Stripe\StripeObject))[] $locations The locations in which this supplier operates.
 ...
 */
class Supplier extends \FooEventsPOS\Stripe\ApiResource
{
     ...
     *
     * @return \FooEventsPOS\Stripe\Collection<Supplier> of ApiResources
     *
