...
namespace FooEventsPOS\Stripe\Climate;
 ...
 * @property null|(object{public_name: string}&\FooEventsPOS\Stripe\StripeObject) $beneficiary
 ...
 * @property ((object{delivered_at: int, location: null|(object{city: null|string, country: string, latitude: null|float, longitude: null|float, region: null|string}&\FooEventsPOS\Stripe\StripeObject), metric_tons: string, registry_url: null|string, supplier: Supplier}&\FooEventsPOS\Stripe\StripeObject))[] $delivery_details Details about the delivery of carbon removal for this order.
 ...
 */
class Order extends \FooEventsPOS\Stripe\ApiResource
{
     ...
     *
     * @return \FooEventsPOS\Stripe\Collection<Order> of ApiResources
     *
     * @throws \FooEventsPOS\Stripe\Exception\ApiErrorException if the request fails
     */
