...
namespace FooEventsPOS\Stripe\ApiOperations;
...
trait Request
{
     ...
     *
     * @throws \FooEventsPOS\Stripe\Exception\InvalidArgumentException if $params exists and is not an array
     */
    protected static function _validateParams($params = null)
    {
        if ($params && !\is_array($params)) {
            ...
            throw new \FooEventsPOS\Stripe\Exception\InvalidArgumentException($message);
        }
    }
    ...
    /**
     * @param string $url URL for the request
     * @param class-string< \FooEventsPOS\Stripe\Collection|\FooEventsPOS\Stripe\SearchResult > $resultClass indicating what type of paginated result is returned
     * @param null|array $params list of parameters for the request
     * @param null|array|string $options
     * @param string[] $usage names of tracked behaviors associated with this request
     *
     * @return \FooEventsPOS\Stripe\Collection|\FooEventsPOS\Stripe\SearchResult
     *
     * @throws \FooEventsPOS\Stripe\Exception\ApiErrorException if the request fails
     */
    protected static function _requestPage($url, $resultClass, $params = null, $options = null, $usage = [])
    {
        ...
        if (!$obj instanceof $resultClass) {
            throw new \FooEventsPOS\Stripe\Exception\UnexpectedValueException(
    ...
    {
        $opts = \FooEventsPOS\Stripe\Util\RequestOptions::parse($options);
        $baseUrl = isset($opts->apiBase) ? $opts->apiBase : static::baseUrl();
        $requestor = new \FooEventsPOS\Stripe\ApiRequestor($opts->apiKey, $baseUrl);
