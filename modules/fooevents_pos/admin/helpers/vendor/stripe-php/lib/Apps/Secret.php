...
namespace FooEventsPOS\Stripe\Apps;
 ...
 * @property (object{type: string, user?: string}&\FooEventsPOS\Stripe\StripeObject) $scope
 */
class Secret extends \FooEventsPOS\Stripe\ApiResource
{
     ...
     *
     * @return \FooEventsPOS\Stripe\Collection<Secret> of ApiResources
     *
     * @throws \FooEventsPOS\Stripe\Exception\ApiErrorException if the request fails
     */
