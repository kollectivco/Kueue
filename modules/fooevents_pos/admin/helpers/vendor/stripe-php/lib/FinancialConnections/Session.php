 ...
 * @property null|(object{account?: string|\FooEventsPOS\Stripe\Account, customer?: string|\FooEventsPOS\Stripe\Customer, type: string}&\FooEventsPOS\Stripe\StripeObject) $account_holder The account holder for whom accounts are collected in this session.
 * @property \FooEventsPOS\Stripe\Collection<Account> $accounts The accounts that were collected as part of this Session.
 * @property string $client_secret A value that will be passed to the client to launch the authentication flow.
 * @property null|(object{account_subcategories: null|string[], countries: null|string[]}&\FooEventsPOS\Stripe\StripeObject) $filters
