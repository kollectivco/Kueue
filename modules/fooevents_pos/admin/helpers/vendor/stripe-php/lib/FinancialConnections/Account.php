...
namespace FooEventsPOS\Stripe\FinancialConnections;
 ...
 * @property null|(object{account?: string|\FooEventsPOS\Stripe\Account, customer?: string|\FooEventsPOS\Stripe\Customer, type: string}&\FooEventsPOS\Stripe\StripeObject) $account_holder The account holder that this account belongs to.
 * @property null|(object{as_of: int, cash?: (object{available: null|\FooEventsPOS\Stripe\StripeObject}&\FooEventsPOS\Stripe\StripeObject), credit?: (object{used: null|\FooEventsPOS\Stripe\StripeObject}&\FooEventsPOS\Stripe\StripeObject), current: \FooEventsPOS\Stripe\StripeObject, type: string}&\FooEventsPOS\Stripe\StripeObject) $balance The most recent information about the account's balance.
 * @property null|(object{last_attempted_at: int, next_refresh_available_at: null|int, status: string}&\FooEventsPOS\Stripe\StripeObject) $balance_refresh The state of the most recent attempt to refresh the account balance.
 ...
 * @property null|(object{last_attempted_at: int, next_refresh_available_at: null|int, status: string}&\FooEventsPOS\Stripe\StripeObject) $ownership_refresh The state of the most recent attempt to refresh the account owners.
 ...
 * @property null|(object{id: string, last_attempted_at: int, next_refresh_available_at: null|int, status: string}&\FooEventsPOS\Stripe\StripeObject) $transaction_refresh The state of the most recent attempt to refresh the account transactions.
 */
class Account extends \FooEventsPOS\Stripe\ApiResource
{
     ...
     *
     * @return \FooEventsPOS\Stripe\Collection<Account> of ApiResources
     *
     ...
     * @param null|array|string $opts
     *
     * @return \FooEventsPOS\Stripe\Collection<AccountOwner> list of account owners
     *
     * @throws \FooEventsPOS\Stripe\Exception\ApiErrorException if the request fails
     */
