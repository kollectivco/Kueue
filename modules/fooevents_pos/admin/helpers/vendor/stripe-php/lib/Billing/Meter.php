 ...
 * @property (object{event_payload_key: string, type: string}&\FooEventsPOS\Stripe\StripeObject) $customer_mapping
 * @property (object{formula: string}&\FooEventsPOS\Stripe\StripeObject) $default_aggregation
 ...
 * @property (object{deactivated_at: null|int}&\FooEventsPOS\Stripe\StripeObject) $status_transitions
 * @property int $updated Time at which the object was last updated. Measured in seconds since the Unix epoch.
 * @property (object{event_payload_key: string}&\FooEventsPOS\Stripe\StripeObject) $value_settings
 */
class Meter extends \FooEventsPOS\Stripe\ApiResource
{
    const OBJECT_NAME = 'billing.meter';

    use \FooEventsPOS\Stripe\ApiOperations\NestedResource;
     ...
     *
     * @return \FooEventsPOS\Stripe\Collection<Meter> of ApiResources
     *
     * @throws \FooEventsPOS\Stripe\Exception\ApiErrorException if the request fails
     */
     ...
     * @param null|array|string $opts
     *
     * @return \FooEventsPOS\Stripe\Collection<MeterEventSummary> the list of meter event summaries
     *
     * @throws \FooEventsPOS\Stripe\Exception\ApiErrorException if the request fails
     */
