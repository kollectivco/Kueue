 ...
 * @property (object{monetary: null|(object{currency: string, value: int}&\FooEventsPOS\Stripe\StripeObject), type: string}&\FooEventsPOS\Stripe\StripeObject) $amount
 * @property (object{scope: (object{price_type?: string, prices?: ((object{id: null|string}&\FooEventsPOS\Stripe\StripeObject))[]}&\FooEventsPOS\Stripe\StripeObject)}&\FooEventsPOS\Stripe\StripeObject) $applicability_config
 ...
 * @property string|\FooEventsPOS\Stripe\Customer $customer ID of the customer receiving the billing credits.
 ...
 * @property null|string|\FooEventsPOS\Stripe\TestHelpers\TestClock $test_clock ID of the test clock this credit grant belongs to.
 ...
 */
class CreditGrant extends \FooEventsPOS\Stripe\ApiResource
{
     ...
     *
     * @return \FooEventsPOS\Stripe\Collection<CreditGrant> of ApiResources
     *
     * @throws \FooEventsPOS\Stripe\Exception\ApiErrorException if the request fails
     */
