 ...
 * @property null|(object{filters: null|((object{customer: null|string|\FooEventsPOS\Stripe\Customer, type: string}&\FooEventsPOS\Stripe\StripeObject))[], gte: int, meter: Meter|string, recurrence: string}&\FooEventsPOS\Stripe\StripeObject) $usage_threshold Encapsulates configuration of the alert to monitor usage on a specific <a href="https://stripe.com/docs/api/billing/meter">Billing Meter</a>.
 */
class Alert extends \FooEventsPOS\Stripe\ApiResource
{
     ...
     *
     * @return \FooEventsPOS\Stripe\Collection<Alert> of ApiResources
     *
     * @throws \FooEventsPOS\Stripe\Exception\ApiErrorException if the request fails
     */
