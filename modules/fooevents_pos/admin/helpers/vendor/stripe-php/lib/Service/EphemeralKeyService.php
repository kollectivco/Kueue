...
class EphemeralKeyService extends AbstractService
{
     ...
     *
     * @return \FooEventsPOS\Stripe\EphemeralKey
     *
    ...
    public function create($params = null, $opts = null)
    {
        if (!$opts || !isset($opts['stripe_version'])) {
            throw new \FooEventsPOS\Stripe\Exception\InvalidArgumentException('stripe_version must be specified to create an ephemeral key');
        }
