...
namespace FooEventsPOS\Stripe\Service\Tax;
 ...
 */
class CalculationService extends \FooEventsPOS\Stripe\Service\AbstractService
{
    /**
     ...
     *
     * @return \FooEventsPOS\Stripe\Collection<\FooEventsPOS\Stripe\Tax\CalculationLineItem>
     *
     ...
     * @param null|RequestOptionsArray|\FooEventsPOS\Stripe\Util\RequestOptions $opts
     *
     * @return \FooEventsPOS\Stripe\Tax\Calculation
     *
     * @throws \FooEventsPOS\Stripe\Exception\ApiErrorException if the request fails
     */
