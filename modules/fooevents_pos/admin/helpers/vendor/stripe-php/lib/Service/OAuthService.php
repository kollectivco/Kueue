...
class OAuthService extends AbstractService
{
     ...
     * @param array|\FooEventsPOS\Stripe\Util\RequestOptions $opts the special modifiers of the request
     *
     * @return \FooEventsPOS\Stripe\StripeObject the object returned by Stripe's Connect API
     */
    ...
    public function authorizeUrl($params = null, $opts = null)
    {
        ...
        $query = \FooEventsPOS\Stripe\Util\Util::encodeParameters($params);
     ...
     * @param null|array $opts
     *
     * @return \FooEventsPOS\Stripe\StripeObject object containing the response from the API
     *
     * @throws \FooEventsPOS\Stripe\Exception\OAuth\OAuthErrorException if the request fails
     */
    ...
    private function _getClientId($params = null)
    {
        ...
        if (null === $clientId) {
            $msg = 'No client_id provided. (HINT: set your client_id using '
              . '`new \FooEventsPOS\Stripe\StripeClient([clientId => <CLIENT-ID>
            ...
            throw new \FooEventsPOS\Stripe\Exception\AuthenticationException($msg);
        }
     ...
     * @param array|\FooEventsPOS\Stripe\Util\RequestOptions $opts the special modifiers of the request
     *
     * @return \FooEventsPOS\Stripe\Util\RequestOptions
     *
     * @throws \FooEventsPOS\Stripe\Exception\InvalidArgumentException
     */
    private function _parseOpts($opts)
    {
        if (\is_array($opts)) {
            if (\array_key_exists('connect_base', $opts)) {
                ...
                // \FooEventsPOS\Stripe\Service\OAuthService from \FooEventsPOS\Stripe\OAuth, where `connect_base`
                // was the name of the parameter that behaves as `api_base` does here.
                throw new \FooEventsPOS\Stripe\Exception\InvalidArgumentException('Use `api_base`, not `connect_base`');
            }
        }

        return \FooEventsPOS\Stripe\Util\RequestOptions::parse($opts);
    }

    /**
     * @param \FooEventsPOS\Stripe\Util\RequestOptions $opts
     *
     * @return string
     */
