...
namespace FooEventsPOS\Stripe\Service\BillingPortal;
 ...
 */
class ConfigurationService extends \FooEventsPOS\Stripe\Service\AbstractService
{
    /**
     ...
     *
     * @return \FooEventsPOS\Stripe\Collection<\FooEventsPOS\Stripe\BillingPortal\Configuration>
     *
     ...
     * @param null|RequestOptionsArray|\FooEventsPOS\Stripe\Util\RequestOptions $opts
     *
     * @return \FooEventsPOS\Stripe\BillingPortal\Configuration
     *
     * @throws \FooEventsPOS\Stripe\Exception\ApiErrorException if the request fails
     */
