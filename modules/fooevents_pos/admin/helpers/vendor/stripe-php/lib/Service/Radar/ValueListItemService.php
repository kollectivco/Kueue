...
namespace FooEventsPOS\Stripe\Service\Radar;
 ...
 */
class ValueListItemService extends \FooEventsPOS\Stripe\Service\AbstractService
{
    /**
     ...
     *
     * @return \FooEventsPOS\Stripe\Collection<\FooEventsPOS\Stripe\Radar\ValueListItem>
     *
     ...
     * @param null|RequestOptionsArray|\FooEventsPOS\Stripe\Util\RequestOptions $opts
     *
     * @return \FooEventsPOS\Stripe\Radar\ValueListItem
     *
     * @throws \FooEventsPOS\Stripe\Exception\ApiErrorException if the request fails
     */
