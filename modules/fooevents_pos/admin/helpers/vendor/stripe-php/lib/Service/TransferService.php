...
class TransferService extends AbstractService
{
     ...
     *
     * @return \FooEventsPOS\Stripe\Collection<\FooEventsPOS\Stripe\Transfer>
     *
     ...
     * @param null|RequestOptionsArray|\FooEventsPOS\Stripe\Util\RequestOptions $opts
     *
     * @return \FooEventsPOS\Stripe\Collection<\FooEventsPOS\Stripe\TransferReversal>
     *
     * @throws \FooEventsPOS\Stripe\Exception\ApiErrorException if the request fails
     */
     ...
     * @param null|RequestOptionsArray|\FooEventsPOS\Stripe\Util\RequestOptions $opts
     *
     * @return \FooEventsPOS\Stripe\Transfer
     *
     * @throws \FooEventsPOS\Stripe\Exception\ApiErrorException if the request fails
     */
     ...
     * @param null|RequestOptionsArray|\FooEventsPOS\Stripe\Util\RequestOptions $opts
     *
     * @return \FooEventsPOS\Stripe\TransferReversal
     *
     * @throws \FooEventsPOS\Stripe\Exception\ApiErrorException if the request fails
     */
