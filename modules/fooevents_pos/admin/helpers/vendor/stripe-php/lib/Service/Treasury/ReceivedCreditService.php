 ...
 */
class ReceivedCreditService extends \FooEventsPOS\Stripe\Service\AbstractService
{
    /**
     ...
     *
     * @return \FooEventsPOS\Stripe\Collection<\FooEventsPOS\Stripe\Treasury\ReceivedCredit>
     *
     ...
     * @param null|RequestOptionsArray|\FooEventsPOS\Stripe\Util\RequestOptions $opts
     *
     * @return \FooEventsPOS\Stripe\Treasury\ReceivedCredit
     *
     * @throws \FooEventsPOS\Stripe\Exception\ApiErrorException if the request fails
     */
