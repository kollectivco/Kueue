...
class FileService extends AbstractService
{
     ...
     *
     * @return \FooEventsPOS\Stripe\Collection<\FooEventsPOS\Stripe\File>
     *
     ...
     * @param null|RequestOptionsArray|\FooEventsPOS\Stripe\Util\RequestOptions $opts
     *
     * @return \FooEventsPOS\Stripe\File
     *
     * @throws \FooEventsPOS\Stripe\Exception\ApiErrorException if the request fails
     */
    ...
    public function create($params = null, $opts = null)
    {
        ...
        $flatParams = \array_column(\FooEventsPOS\Stripe\Util\Util::flattenParams($params), 1, 0);
