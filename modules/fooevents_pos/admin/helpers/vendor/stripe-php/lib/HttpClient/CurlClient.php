...
namespace FooEventsPOS\Stripe\HttpClient;

use FooEventsPOS\Stripe\Exception;
use FooEventsPOS\Stripe\Stripe;
use FooEventsPOS\Stripe\Util;
...
class CurlClient implements ClientInterface, StreamingClientInterface
{
     ...
     *   <li>\FooEventsPOS\Stripe\Util\CaseInsensitiveArray $rheaders The response headers</li>
