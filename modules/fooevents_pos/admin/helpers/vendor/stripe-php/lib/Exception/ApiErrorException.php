...
abstract class ApiErrorException extends \Exception implements ExceptionInterface
{
     ...
     * @param null|array|\FooEventsPOS\Stripe\Util\CaseInsensitiveArray $httpHeaders the HTTP headers array
     ...
     *
     * @return null|\FooEventsPOS\Stripe\ErrorObject
     */
     ...
     *
     * @param null|\FooEventsPOS\Stripe\ErrorObject $error
     */
     ...
     *
     * @return null|array|\FooEventsPOS\Stripe\Util\CaseInsensitiveArray
     */
     ...
     *
     * @param null|array|\FooEventsPOS\Stripe\Util\CaseInsensitiveArray $httpHeaders
     */
     ...
     *
     * Cf. the `CODE_*` constants on {@see \FooEventsPOS\Stripe\ErrorObject} for possible
     * values.
     *
     * @return null|string
     */
    ...
    protected function constructErrorObject()
    {
        ...
        return \FooEventsPOS\Stripe\ErrorObject::constructFrom($this->jsonBody['error']);
    }
}
