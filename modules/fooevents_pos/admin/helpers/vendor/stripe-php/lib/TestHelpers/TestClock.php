...
namespace FooEventsPOS\Stripe\TestHelpers;
 ...
 * @property (object{advancing?: (object{target_frozen_time: int}&\FooEventsPOS\Stripe\StripeObject)}&\FooEventsPOS\Stripe\StripeObject) $status_details
 */
class TestClock extends \FooEventsPOS\Stripe\ApiResource
{
     ...
     * @param null|array|string $opts
     *
     * @return \FooEventsPOS\Stripe\Collection<TestClock> of ApiResources
     *
     * @throws \FooEventsPOS\Stripe\Exception\ApiErrorException if the request fails
     */
