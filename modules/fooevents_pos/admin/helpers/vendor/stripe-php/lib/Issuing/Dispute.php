 ...
 * @property null|\FooEventsPOS\Stripe\BalanceTransaction[] $balance_transactions List of balance transactions associated with the dispute.
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property string $currency The currency the <code>transaction</code> was made in.
 * @property (object{canceled?: (object{additional_documentation: null|string|\FooEventsPOS\Stripe\File, canceled_at: null|int, cancellation_policy_provided: null|bool, cancellation_reason: null|string, expected_at: null|int, explanation: null|string, product_description: null|string, product_type: null|string, return_status: null|string, returned_at: null|int}&\FooEventsPOS\Stripe\StripeObject), duplicate?: (object{additional_documentation: null|string|\FooEventsPOS\Stripe\File, card_statement: null|string|\FooEventsPOS\Stripe\File, cash_receipt: null|string|\FooEventsPOS\Stripe\File, check_image: null|string|\FooEventsPOS\Stripe\File, explanation: null|string, original_transaction: null|string}&\FooEventsPOS\Stripe\StripeObject), fraudulent?: (object{additional_documentation: null|string|\FooEventsPOS\Stripe\File, explanation: null|string}&\FooEventsPOS\Stripe\StripeObject), merchandise_not_as_described?: (object{additional_documentation: null|string|\FooEventsPOS\Stripe\File, explanation: null|string, received_at: null|int, return_description: null|string, return_status: null|string, returned_at: null|int}&\FooEventsPOS\Stripe\StripeObject), no_valid_authorization?: (object{additional_documentation: null|string|\FooEventsPOS\Stripe\File, explanation: null|string}&\FooEventsPOS\Stripe\StripeObject), not_received?: (object{additional_documentation: null|string|\FooEventsPOS\Stripe\File, expected_at: null|int, explanation: null|string, product_description: null|string, product_type: null|string}&\FooEventsPOS\Stripe\StripeObject), other?: (object{additional_documentation: null|string|\FooEventsPOS\Stripe\File, explanation: null|string, product_description: null|string, product_type: null|string}&\FooEventsPOS\Stripe\StripeObject), reason: string, service_not_as_described?: (object{additional_documentation: null|string|\FooEventsPOS\Stripe\File, canceled_at: null|int, cancellation_reason: null|string, explanation: null|string, received_at: null|int}&\FooEventsPOS\Stripe\StripeObject)}&\FooEventsPOS\Stripe\StripeObject) $evidence
 ...
 * @property null|(object{debit_reversal: null|string, received_debit: string}&\FooEventsPOS\Stripe\StripeObject) $treasury <a href="https://stripe.com/docs/api/treasury">Treasury</a> details related to this dispute if it was created on a [FinancialAccount](/docs/api/treasury/financial_accounts
 */
class Dispute extends \FooEventsPOS\Stripe\ApiResource
{
     ...
     *
     * @return \FooEventsPOS\Stripe\Collection<Dispute> of ApiResources
     *
     * @throws \FooEventsPOS\Stripe\Exception\ApiErrorException if the request fails
     */
