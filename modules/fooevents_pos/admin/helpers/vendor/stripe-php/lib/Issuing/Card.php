 ...
 * @property null|(object{address: (object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\FooEventsPOS\Stripe\StripeObject), address_validation: null|(object{mode: string, normalized_address: null|(object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\FooEventsPOS\Stripe\StripeObject), result: null|string}&\FooEventsPOS\Stripe\StripeObject), carrier: null|string, customs: null|(object{eori_number: null|string}&\FooEventsPOS\Stripe\StripeObject), eta: null|int, name: string, phone_number: null|string, require_signature: null|bool, service: string, status: null|string, tracking_number: null|string, tracking_url: null|string, type: string}&\FooEventsPOS\Stripe\StripeObject) $shipping Where and how the card will be shipped.
 * @property (object{allowed_categories: null|string[], allowed_merchant_countries: null|string[], blocked_categories: null|string[], blocked_merchant_countries: null|string[], spending_limits: null|((object{amount: int, categories: null|string[], interval: string}&\FooEventsPOS\Stripe\StripeObject))[], spending_limits_currency: null|string}&\FooEventsPOS\Stripe\StripeObject) $spending_controls
 ...
 * @property null|(object{apple_pay: (object{eligible: bool, ineligible_reason: null|string}&\FooEventsPOS\Stripe\StripeObject), google_pay: (object{eligible: bool, ineligible_reason: null|string}&\FooEventsPOS\Stripe\StripeObject), primary_account_identifier: null|string}&\FooEventsPOS\Stripe\StripeObject) $wallets Information relating to digital wallets (like Apple Pay and Google Pay).
 */
class Card extends \FooEventsPOS\Stripe\ApiResource
{
     ...
     *
     * @return \FooEventsPOS\Stripe\Collection<Card> of ApiResources
     *
     * @throws \FooEventsPOS\Stripe\Exception\ApiErrorException if the request fails
     */
