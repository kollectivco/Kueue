 ...
 * @property string|\FooEventsPOS\Stripe\Charge $charge ID of the charge this early fraud warning is for, optionally expanded.
 ...
 * @property null|string|\FooEventsPOS\Stripe\PaymentIntent $payment_intent ID of the Payment Intent this early fraud warning is for, optionally expanded.
 */
class EarlyFraudWarning extends \FooEventsPOS\Stripe\ApiResource
{
     ...
     *
     * @return \FooEventsPOS\Stripe\Collection<EarlyFraudWarning> of ApiResources
     *
