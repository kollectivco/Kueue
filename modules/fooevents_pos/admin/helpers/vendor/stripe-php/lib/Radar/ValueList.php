...
namespace FooEventsPOS\Stripe\Radar;
 ...
 * @property \FooEventsPOS\Stripe\Collection<ValueListItem> $list_items List of items contained within this value list.
 ...
 */
class ValueList extends \FooEventsPOS\Stripe\ApiResource
{
     ...
     * @param null|array|string $opts
     *
     * @return \FooEventsPOS\Stripe\Collection<ValueList> of ApiResources
     *
     * @throws \FooEventsPOS\Stripe\Exception\ApiErrorException if the request fails
     */
