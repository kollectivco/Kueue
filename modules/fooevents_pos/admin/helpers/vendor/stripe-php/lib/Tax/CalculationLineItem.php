 ...
 * @property null|((object{amount: int, jurisdiction: (object{country: string, display_name: string, level: string, state: null|string}&\FooEventsPOS\Stripe\StripeObject), sourcing: string, tax_rate_details: null|(object{display_name: string, percentage_decimal: string, tax_type: string}&\FooEventsPOS\Stripe\StripeObject), taxability_reason: string, taxable_amount: int}&\FooEventsPOS\Stripe\StripeObject))[] $tax_breakdown Detailed account of taxes relevant to this line item.
 * @property string $tax_code The <a href="https://stripe.com/docs/tax/tax-categories">tax code</a> ID used for this resource.
 */
class CalculationLineItem extends \FooEventsPOS\Stripe\ApiResource
{
