 ...
 * @property null|(object{after_completion: (object{hosted_confirmation: null|(object{custom_message: null|string}&\FooEventsPOS\Stripe\StripeObject), redirect: null|(object{return_url: string}&\FooEventsPOS\Stripe\StripeObject), type: string}&\FooEventsPOS\Stripe\StripeObject), subscription_cancel: null|(object{retention: null|(object{coupon_offer: null|(object{coupon: string}&\FooEventsPOS\Stripe\StripeObject), type: string}&\FooEventsPOS\Stripe\StripeObject), subscription: string}&\FooEventsPOS\Stripe\StripeObject), subscription_update: null|(object{subscription: string}&\FooEventsPOS\Stripe\StripeObject), subscription_update_confirm: null|(object{discounts: null|((object{coupon: null|string, promotion_code: null|string}&\FooEventsPOS\Stripe\StripeObject))[], items: ((object{id: null|string, price: null|string, quantity?: int}&\FooEventsPOS\Stripe\StripeObject))[], subscription: string}&\FooEventsPOS\Stripe\StripeObject), type: string}&\FooEventsPOS\Stripe\StripeObject) $flow Information about a specific flow for the customer to go through. See the <a href="https://stripe.com/docs/customer-management/portal-deep-links">docs</a> to learn more about using customer portal deep links and flows.
