...
namespace FooEventsPOS\Stripe\BillingPortal;
 ...
 * @property null|string|\FooEventsPOS\Stripe\Application $application ID of the Connect Application that created the configuration.
 * @property (object{headline: null|string, privacy_policy_url: null|string, terms_of_service_url: null|string}&\FooEventsPOS\Stripe\StripeObject) $business_profile
 ...
 * @property (object{customer_update: (object{allowed_updates: string[], enabled: bool}&\FooEventsPOS\Stripe\StripeObject), invoice_history: (object{enabled: bool}&\FooEventsPOS\Stripe\StripeObject), payment_method_update: (object{enabled: bool}&\FooEventsPOS\Stripe\StripeObject), subscription_cancel: (object{cancellation_reason: (object{enabled: bool, options: string[]}&\FooEventsPOS\Stripe\StripeObject), enabled: bool, mode: string, proration_behavior: string}&\FooEventsPOS\Stripe\StripeObject), subscription_update: (object{default_allowed_updates: string[], enabled: bool, products?: null|((object{adjustable_quantity: (object{enabled: bool, maximum: null|int, minimum: int}&\FooEventsPOS\Stripe\StripeObject), prices: string[], product: string}&\FooEventsPOS\Stripe\StripeObject))[], proration_behavior: string, schedule_at_period_end: (object{conditions: (object{type: string}&\FooEventsPOS\Stripe\StripeObject)[]}&\FooEventsPOS\Stripe\StripeObject)}&\FooEventsPOS\Stripe\StripeObject)}&\FooEventsPOS\Stripe\StripeObject) $features
 ...
 * @property (object{enabled: bool, url: null|string}&\FooEventsPOS\Stripe\StripeObject) $login_page
