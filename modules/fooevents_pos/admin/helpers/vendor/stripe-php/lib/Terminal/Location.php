 ...
 * @property (object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\FooEventsPOS\Stripe\StripeObject) $address
 ...
 */
class Location extends \FooEventsPOS\Stripe\ApiResource
{
     ...
     * @param null|array|string $opts
     *
     * @return \FooEventsPOS\Stripe\Collection<Location> of ApiResources
     *
     * @throws \FooEventsPOS\Stripe\Exception\ApiErrorException if the request fails
     */
