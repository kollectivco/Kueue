...
namespace FooEventsPOS\Stripe\Terminal;
 ...
 * @property null|(object{splashscreen?: string|\FooEventsPOS\Stripe\File}&\FooEventsPOS\Stripe\StripeObject) $bbpos_wisepos_e
 ...
 * @property null|(object{enabled: null|bool}&\FooEventsPOS\Stripe\StripeObject) $offline
 * @property null|(object{end_hour: int, start_hour: int}&\FooEventsPOS\Stripe\StripeObject) $reboot_window
 * @property null|(object{splashscreen?: string|\FooEventsPOS\Stripe\File}&\FooEventsPOS\Stripe\StripeObject) $stripe_s700
 * @property null|(object{aed?: (object{fixed_amounts?: null|int[], percentages?: null|int[], smart_tip_threshold?: int}&\FooEventsPOS\Stripe\StripeObject), aud?: (object{fixed_amounts?: null|int[], percentages?: null|int[], smart_tip_threshold?: int}&\FooEventsPOS\Stripe\StripeObject), bgn?: (object{fixed_amounts?: null|int[], percentages?: null|int[], smart_tip_threshold?: int}&\FooEventsPOS\Stripe\StripeObject), cad?: (object{fixed_amounts?: null|int[], percentages?: null|int[], smart_tip_threshold?: int}&\FooEventsPOS\Stripe\StripeObject), chf?: (object{fixed_amounts?: null|int[], percentages?: null|int[], smart_tip_threshold?: int}&\FooEventsPOS\Stripe\StripeObject), czk?: (object{fixed_amounts?: null|int[], percentages?: null|int[], smart_tip_threshold?: int}&\FooEventsPOS\Stripe\StripeObject), dkk?: (object{fixed_amounts?: null|int[], percentages?: null|int[], smart_tip_threshold?: int}&\FooEventsPOS\Stripe\StripeObject), eur?: (object{fixed_amounts?: null|int[], percentages?: null|int[], smart_tip_threshold?: int}&\FooEventsPOS\Stripe\StripeObject), gbp?: (object{fixed_amounts?: null|int[], percentages?: null|int[], smart_tip_threshold?: int}&\FooEventsPOS\Stripe\StripeObject), hkd?: (object{fixed_amounts?: null|int[], percentages?: null|int[], smart_tip_threshold?: int}&\FooEventsPOS\Stripe\StripeObject), huf?: (object{fixed_amounts?: null|int[], percentages?: null|int[], smart_tip_threshold?: int}&\FooEventsPOS\Stripe\StripeObject), jpy?: (object{fixed_amounts?: null|int[], percentages?: null|int[], smart_tip_threshold?: int}&\FooEventsPOS\Stripe\StripeObject), myr?: (object{fixed_amounts?: null|int[], percentages?: null|int[], smart_tip_threshold?: int}&\FooEventsPOS\Stripe\StripeObject), nok?: (object{fixed_amounts?: null|int[], percentages?: null|int[], smart_tip_threshold?: int}&\FooEventsPOS\Stripe\StripeObject), nzd?: (object{fixed_amounts?: null|int[], percentages?: null|int[], smart_tip_threshold?: int}&\FooEventsPOS\Stripe\StripeObject), pln?: (object{fixed_amounts?: null|int[], percentages?: null|int[], smart_tip_threshold?: int}&\FooEventsPOS\Stripe\StripeObject), ron?: (object{fixed_amounts?: null|int[], percentages?: null|int[], smart_tip_threshold?: int}&\FooEventsPOS\Stripe\StripeObject), sek?: (object{fixed_amounts?: null|int[], percentages?: null|int[], smart_tip_threshold?: int}&\FooEventsPOS\Stripe\StripeObject), sgd?: (object{fixed_amounts?: null|int[], percentages?: null|int[], smart_tip_threshold?: int}&\FooEventsPOS\Stripe\StripeObject), usd?: (object{fixed_amounts?: null|int[], percentages?: null|int[], smart_tip_threshold?: int}&\FooEventsPOS\Stripe\StripeObject)}&\FooEventsPOS\Stripe\StripeObject) $tipping
 * @property null|(object{splashscreen?: string|\FooEventsPOS\Stripe\File}&\FooEventsPOS\Stripe\StripeObject) $verifone_p400
 * @property null|(object{enterprise_eap_peap?: (object{ca_certificate_file?: string, password: string, ssid: string, username: string}&\FooEventsPOS\Stripe\StripeObject), enterprise_eap_tls?: (object{ca_certificate_file?: string, client_certificate_file: string, private_key_file: string, private_key_file_password?: string, ssid: string}&\FooEventsPOS\Stripe\StripeObject), personal_psk?: (object{password: string, ssid: string}&\FooEventsPOS\Stripe\StripeObject), type: string}&\FooEventsPOS\Stripe\StripeObject) $wifi
 */
class Configuration extends \FooEventsPOS\Stripe\ApiResource
{
     ...
     * @param null|array|string $opts
     *
     * @return \FooEventsPOS\Stripe\Collection<Configuration> of ApiResources
     *
     * @throws \FooEventsPOS\Stripe\Exception\ApiErrorException if the request fails
     */
