...
namespace FooEventsPOS\Stripe\Sigma;
 ...
 * @property null|(object{message: string}&\FooEventsPOS\Stripe\StripeObject) $error
 * @property null|\FooEventsPOS\Stripe\File $file The file object representing the results of the query.
 ...
 */
class ScheduledQueryRun extends \FooEventsPOS\Stripe\ApiResource
{
     ...
     *
     * @return \FooEventsPOS\Stripe\Collection<ScheduledQueryRun> of ApiResources
     *
