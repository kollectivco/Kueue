 ...
 * @property null|(object{code: null|string, reason: null|string}&\FooEventsPOS\Stripe\StripeObject) $last_error If present, this property tells you the last error encountered when processing the verification.
 ...
 * @property null|(object{document?: (object{allowed_types?: string[], require_id_number?: bool, require_live_capture?: bool, require_matching_selfie?: bool}&\FooEventsPOS\Stripe\StripeObject), email?: (object{require_verification?: bool}&\FooEventsPOS\Stripe\StripeObject), id_number?: (object{}&\FooEventsPOS\Stripe\StripeObject), matching?: (object{dob?: string, name?: string}&\FooEventsPOS\Stripe\StripeObject), phone?: (object{require_verification?: bool}&\FooEventsPOS\Stripe\StripeObject)}&\FooEventsPOS\Stripe\StripeObject) $options A set of options for the session’s verification checks.
 * @property null|(object{email?: string, phone?: string}&\FooEventsPOS\Stripe\StripeObject) $provided_details Details provided about the user being verified. These details may be shown to the user.
 * @property null|(object{status: string}&\FooEventsPOS\Stripe\StripeObject) $redaction Redaction status of this VerificationSession. If the VerificationSession is not redacted, this field will be null.
 * @property null|string $related_customer Customer ID
 * @property null|(object{account: string, person: string}&\FooEventsPOS\Stripe\StripeObject) $related_person
 ...
 * @property null|(object{address: null|(object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\FooEventsPOS\Stripe\StripeObject), dob?: null|(object{day: null|int, month: null|int, year: null|int}&\FooEventsPOS\Stripe\StripeObject), email: null|string, first_name: null|string, id_number?: null|string, id_number_type: null|string, last_name: null|string, phone: null|string, sex?: null|string, unparsed_place_of_birth?: null|string, unparsed_sex?: null|string}&\FooEventsPOS\Stripe\StripeObject) $verified_outputs The user’s verified data.
 */
class VerificationSession extends \FooEventsPOS\Stripe\ApiResource
{
     ...
     *
     * @return \FooEventsPOS\Stripe\Collection<VerificationSession> of ApiResources
     *
     * @throws \FooEventsPOS\Stripe\Exception\ApiErrorException if the request fails
     */
