...
namespace FooEventsPOS\Stripe;

use FooEventsPOS\Stripe\Util\Util;
...
class BaseStripeClient implements StripeClientInterface, StripeStreamingClientInterface
{
    ...
    const DEFAULT_CONFIG = [
        ...
        'stripe_account' => null,
        'stripe_context' => null,
        'stripe_version' => \FooEventsPOS\Stripe\Util\ApiVersion::CURRENT,
    ...
    /** @var \FooEventsPOS\Stripe\Util\RequestOptions */
    private $defaultOpts;
    ...
    public function __construct($config = [])
    {
        ...
        $this->defaultOpts = \FooEventsPOS\Stripe\Util\RequestOptions::parse([
