 ...
 * @property null|(object{code: string}&\FooEventsPOS\Stripe\StripeObject) $failure_details Details about this InboundTransfer's failure. Only set when status is <code>failed</code>.
 ...
 * @property (object{received_debit: null|string}&\FooEventsPOS\Stripe\StripeObject) $linked_flows
 ...
 * @property null|(object{billing_details: (object{address: (object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\FooEventsPOS\Stripe\StripeObject), email: null|string, name: null|string}&\FooEventsPOS\Stripe\StripeObject), type: string, us_bank_account?: (object{account_holder_type: null|string, account_type: null|string, bank_name: null|string, fingerprint: null|string, last4: null|string, mandate?: string|\FooEventsPOS\Stripe\Mandate, network: string, routing_number: null|string}&\FooEventsPOS\Stripe\StripeObject)}&\FooEventsPOS\Stripe\StripeObject) $origin_payment_method_details Details about the PaymentMethod for an InboundTransfer.
 ...
 * @property (object{canceled_at?: null|int, failed_at: null|int, succeeded_at: null|int}&\FooEventsPOS\Stripe\StripeObject) $status_transitions
 * @property null|string|Transaction $transaction The Transaction associated with this object.
 */
class InboundTransfer extends \FooEventsPOS\Stripe\ApiResource
{
     ...
     *
     * @return \FooEventsPOS\Stripe\Collection<InboundTransfer> of ApiResources
     *
     * @throws \FooEventsPOS\Stripe\Exception\ApiErrorException if the request fails
     */
