 ...
 * @property (object{balance?: string, billing_details: (object{address: (object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\FooEventsPOS\Stripe\StripeObject), email: null|string, name: null|string}&\FooEventsPOS\Stripe\StripeObject), financial_account?: (object{id: string, network: string}&\FooEventsPOS\Stripe\StripeObject), issuing_card?: string, type: string, us_bank_account?: (object{bank_name: null|string, last4: null|string, routing_number: null|string}&\FooEventsPOS\Stripe\StripeObject)}&\FooEventsPOS\Stripe\StripeObject) $initiating_payment_method_details
 * @property (object{credit_reversal: null|string, issuing_authorization: null|string, issuing_transaction: null|string, source_flow: null|string, source_flow_details?: null|(object{credit_reversal?: CreditReversal, outbound_payment?: OutboundPayment, outbound_transfer?: OutboundTransfer, payout?: \FooEventsPOS\Stripe\Payout, type: string}&\FooEventsPOS\Stripe\StripeObject), source_flow_type: null|string}&\FooEventsPOS\Stripe\StripeObject) $linked_flows
 * @property bool $livemode Has the value <code>true</code> if the object exists in live mode or the value <code>false</code> if the object exists in test mode.
 * @property string $network The rails used to send the funds.
 * @property null|(object{deadline: null|int, restricted_reason: null|string}&\FooEventsPOS\Stripe\StripeObject) $reversal_details Details describing when a ReceivedCredit may be reversed.
 ...
 */
class ReceivedCredit extends \FooEventsPOS\Stripe\ApiResource
{
     ...
     *
     * @return \FooEventsPOS\Stripe\Collection<ReceivedCredit> of ApiResources
     *
