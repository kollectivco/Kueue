 ...
 * @property (object{cash: \FooEventsPOS\Stripe\StripeObject, inbound_pending: \FooEventsPOS\Stripe\StripeObject, outbound_pending: \FooEventsPOS\Stripe\StripeObject}&\FooEventsPOS\Stripe\StripeObject) $balance Balance information for the FinancialAccount
 ...
 * @property ((object{aba?: (object{account_holder_name: string, account_number?: null|string, account_number_last4: string, bank_name: string, routing_number: string}&\FooEventsPOS\Stripe\StripeObject), supported_networks?: string[], type: string}&\FooEventsPOS\Stripe\StripeObject))[] $financial_addresses The set of credentials that resolve to a FinancialAccount.
 ...
 * @property null|(object{inbound_flows: null|string, outbound_flows: null|string}&\FooEventsPOS\Stripe\StripeObject) $platform_restrictions The set of functionalities that the platform can restrict on the FinancialAccount.
 ...
 * @property (object{closed: null|(object{reasons: string[]}&\FooEventsPOS\Stripe\StripeObject)}&\FooEventsPOS\Stripe\StripeObject) $status_details
 ...
 */
class FinancialAccount extends \FooEventsPOS\Stripe\ApiResource
{
     ...
     *
     * @return \FooEventsPOS\Stripe\Collection<FinancialAccount> of ApiResources
     *
     * @throws \FooEventsPOS\Stripe\Exception\ApiErrorException if the request fails
     */
    ...
    public function retrieveFeatures($params = null, $opts = null)
    {
        ...
        $obj = \FooEventsPOS\Stripe\Util\Util::convertToStripeObject($response, $opts);
        $obj->setLastResponse($response);
