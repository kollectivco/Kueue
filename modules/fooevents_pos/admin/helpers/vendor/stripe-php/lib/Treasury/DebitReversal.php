 ...
 * @property null|(object{issuing_dispute: null|string}&\FooEventsPOS\Stripe\StripeObject) $linked_flows Other flows linked to a DebitReversal.
 ...
 * @property (object{completed_at: null|int}&\FooEventsPOS\Stripe\StripeObject) $status_transitions
 * @property null|string|Transaction $transaction The Transaction associated with this object.
 */
class DebitReversal extends \FooEventsPOS\Stripe\ApiResource
{
     ...
     *
     * @return \FooEventsPOS\Stripe\Collection<DebitReversal> of ApiResources
     *
     * @throws \FooEventsPOS\Stripe\Exception\ApiErrorException if the request fails
     */
