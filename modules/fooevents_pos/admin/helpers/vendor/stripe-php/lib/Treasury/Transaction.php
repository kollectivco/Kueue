 ...
 * @property (object{cash: int, inbound_pending: int, outbound_pending: int}&\FooEventsPOS\Stripe\StripeObject) $balance_impact Change to a FinancialAccount's balance
 ...
 * @property null|\FooEventsPOS\Stripe\Collection<TransactionEntry> $entries A list of TransactionEntries that are part of this Transaction. This cannot be expanded in any list endpoints.
 ...
 * @property null|(object{credit_reversal?: CreditReversal, debit_reversal?: DebitReversal, inbound_transfer?: InboundTransfer, issuing_authorization?: \FooEventsPOS\Stripe\Issuing\Authorization, outbound_payment?: OutboundPayment, outbound_transfer?: OutboundTransfer, received_credit?: ReceivedCredit, received_debit?: ReceivedDebit, type: string}&\FooEventsPOS\Stripe\StripeObject) $flow_details Details of the flow that created the Transaction.
 ...
 * @property (object{posted_at: null|int, void_at: null|int}&\FooEventsPOS\Stripe\StripeObject) $status_transitions
 */
