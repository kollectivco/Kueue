...
namespace FooEventsPOS\Stripe\Treasury;
 ...
 * @property null|(object{billing_details: (object{address: (object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\FooEventsPOS\Stripe\StripeObject), email: null|string, name: null|string}&\FooEventsPOS\Stripe\StripeObject), financial_account?: (object{id: string, network: string}&\FooEventsPOS\Stripe\StripeObject), type: string, us_bank_account?: (object{account_holder_type: null|string, account_type: null|string, bank_name: null|string, fingerprint: null|string, last4: null|string, mandate?: string|\FooEventsPOS\Stripe\Mandate, network: string, routing_number: null|string}&\FooEventsPOS\Stripe\StripeObject)}&\FooEventsPOS\Stripe\StripeObject) $destination_payment_method_details Details about the PaymentMethod for an OutboundPayment.
 * @property null|(object{ip_address: null|string, present: bool}&\FooEventsPOS\Stripe\StripeObject) $end_user_details Details about the end user.
 ...
 * @property null|(object{code: string, transaction: string|Transaction}&\FooEventsPOS\Stripe\StripeObject) $returned_details Details about a returned OutboundPayment. Only set when the status is <code>returned</code>.
 ...
 * @property (object{canceled_at: null|int, failed_at: null|int, posted_at: null|int, returned_at: null|int}&\FooEventsPOS\Stripe\StripeObject) $status_transitions
 * @property null|(object{ach?: (object{trace_id: string}&\FooEventsPOS\Stripe\StripeObject), type: string, us_domestic_wire?: (object{chips: null|string, imad: null|string, omad: null|string}&\FooEventsPOS\Stripe\StripeObject)}&\FooEventsPOS\Stripe\StripeObject) $tracking_details Details about network-specific tracking information if available.
 * @property string|Transaction $transaction The Transaction associated with this object.
 */
class OutboundPayment extends \FooEventsPOS\Stripe\ApiResource
{
     ...
     *
     * @return \FooEventsPOS\Stripe\Collection<OutboundPayment> of ApiResources
     *
     * @throws \FooEventsPOS\Stripe\Exception\ApiErrorException if the request fails
     */
