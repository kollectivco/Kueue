 ...
 * @property null|(object{balance?: string, billing_details: (object{address: (object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\FooEventsPOS\Stripe\StripeObject), email: null|string, name: null|string}&\FooEventsPOS\Stripe\StripeObject), financial_account?: (object{id: string, network: string}&\FooEventsPOS\Stripe\StripeObject), issuing_card?: string, type: string, us_bank_account?: (object{bank_name: null|string, last4: null|string, routing_number: null|string}&\FooEventsPOS\Stripe\StripeObject)}&\FooEventsPOS\Stripe\StripeObject) $initiating_payment_method_details
 * @property (object{debit_reversal: null|string, inbound_transfer: null|string, issuing_authorization: null|string, issuing_transaction: null|string, payout: null|string}&\FooEventsPOS\Stripe\StripeObject) $linked_flows
 * @property bool $livemode Has the value <code>true</code> if the object exists in live mode or the value <code>false</code> if the object exists in test mode.
 * @property string $network The network used for the ReceivedDebit.
 * @property null|(object{deadline: null|int, restricted_reason: null|string}&\FooEventsPOS\Stripe\StripeObject) $reversal_details Details describing when a ReceivedDebit might be reversed.
 ...
 */
class ReceivedDebit extends \FooEventsPOS\Stripe\ApiResource
{
     ...
     *
     * @return \FooEventsPOS\Stripe\Collection<ReceivedDebit> of ApiResources
     *
