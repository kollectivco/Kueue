...
namespace FooEventsPOS\Stripe\Checkout;
 ...
 * @property null|(object{enabled: bool}&\FooEventsPOS\Stripe\StripeObject) $adaptive_pricing Settings for price localization with <a href="https://docs.stripe.com/payments/checkout/adaptive-pricing">Adaptive Pricing</a>.
 * @property null|(object{recovery: null|(object{allow_promotion_codes: bool, enabled: bool, expires_at: null|int, url: null|string}&\FooEventsPOS\Stripe\StripeObject)}&\FooEventsPOS\Stripe\StripeObject) $after_expiration When set, provides configuration for actions to take if this Checkout Session expires.
 ...
 * @property (object{enabled: bool, liability: null|(object{account?: string|\FooEventsPOS\Stripe\Account, type: string}&\FooEventsPOS\Stripe\StripeObject), provider: null|string, status: null|string}&\FooEventsPOS\Stripe\StripeObject) $automatic_tax
 ...
 * @property null|(object{shipping_details: null|(object{address: (object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\FooEventsPOS\Stripe\StripeObject), name: string}&\FooEventsPOS\Stripe\StripeObject)}&\FooEventsPOS\Stripe\StripeObject) $collected_information Information about the customer collected within the Checkout Session.
 * @property null|(object{promotions: null|string, terms_of_service: null|string}&\FooEventsPOS\Stripe\StripeObject) $consent Results of <code>consent_collection</code> for this session.
 * @property null|(object{payment_method_reuse_agreement: null|(object{position: string}&\FooEventsPOS\Stripe\StripeObject), promotions: null|string, terms_of_service: null|string}&\FooEventsPOS\Stripe\StripeObject) $consent_collection When set, provides configuration for the Checkout Session to gather active consent from customers.
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property null|string $currency Three-letter <a href="https://www.iso.org/iso-4217-currency-codes.html">ISO currency code</a>, in lowercase. Must be a <a href="https://stripe.com/docs/currencies">supported currency</a>.
 * @property null|(object{amount_subtotal: int, amount_total: int, fx_rate: string, source_currency: string}&\FooEventsPOS\Stripe\StripeObject) $currency_conversion Currency conversion details for <a href="https://docs.stripe.com/payments/checkout/adaptive-pricing">Adaptive Pricing</a> sessions created before 2025-03-31.
 * @property ((object{dropdown?: (object{default_value: null|string, options: (object{label: string, value: string}&\FooEventsPOS\Stripe\StripeObject)[], value: null|string}&\FooEventsPOS\Stripe\StripeObject), key: string, label: (object{custom: null|string, type: string}&\FooEventsPOS\Stripe\StripeObject), numeric?: (object{default_value: null|string, maximum_length: null|int, minimum_length: null|int, value: null|string}&\FooEventsPOS\Stripe\StripeObject), optional: bool, text?: (object{default_value: null|string, maximum_length: null|int, minimum_length: null|int, value: null|string}&\FooEventsPOS\Stripe\StripeObject), type: string}&\FooEventsPOS\Stripe\StripeObject))[] $custom_fields Collect additional information from your customer using custom fields. Up to 3 fields are supported.
 * @property (object{after_submit: null|(object{message: string}&\FooEventsPOS\Stripe\StripeObject), shipping_address: null|(object{message: string}&\FooEventsPOS\Stripe\StripeObject), submit: null|(object{message: string}&\FooEventsPOS\Stripe\StripeObject), terms_of_service_acceptance: null|(object{message: string}&\FooEventsPOS\Stripe\StripeObject)}&\FooEventsPOS\Stripe\StripeObject) $custom_text
 * @property null|string|\FooEventsPOS\Stripe\Customer $customer The ID of the customer for this Session. For Checkout Sessions in <code>subscription</code> mode or Checkout Sessions with <code>customer_creation</code> set as <code>always</code> in <code>payment</code> mode, Checkout will create a new customer object based on information provided during the payment flow unless an existing customer was provided when the Session was created.
 ...
 * @property null|(object{address: null|(object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\FooEventsPOS\Stripe\StripeObject), email: null|string, name: null|string, phone: null|string, tax_exempt: null|string, tax_ids: null|((object{type: string, value: null|string}&\FooEventsPOS\Stripe\StripeObject))[]}&\FooEventsPOS\Stripe\StripeObject) $customer_details The customer details including the customer's tax exempt status and the customer's tax IDs. Customer's address details are not present on Sessions in <code>setup</code> mode.
 ...
 * @property null|((object{coupon: null|string|\FooEventsPOS\Stripe\Coupon, promotion_code: null|string|\FooEventsPOS\Stripe\PromotionCode}&\FooEventsPOS\Stripe\StripeObject))[] $discounts List of coupons and promotion codes attached to the Checkout Session.
 * @property int $expires_at The timestamp at which the Checkout Session will expire.
 * @property null|string|\FooEventsPOS\Stripe\Invoice $invoice ID of the invoice created by the Checkout Session, if it exists.
 * @property null|(object{enabled: bool, invoice_data: (object{account_tax_ids: null|(string|\FooEventsPOS\Stripe\TaxId)[], custom_fields: null|(object{name: string, value: string}&\FooEventsPOS\Stripe\StripeObject)[], description: null|string, footer: null|string, issuer: null|(object{account?: string|\FooEventsPOS\Stripe\Account, type: string}&\FooEventsPOS\Stripe\StripeObject), metadata: null|\FooEventsPOS\Stripe\StripeObject, rendering_options: null|(object{amount_tax_display: null|string, template: null|string}&\FooEventsPOS\Stripe\StripeObject)}&\FooEventsPOS\Stripe\StripeObject)}&\FooEventsPOS\Stripe\StripeObject) $invoice_creation Details on the state of invoice creation for the Checkout Session.
 * @property null|\FooEventsPOS\Stripe\Collection<\FooEventsPOS\Stripe\LineItem> $line_items The line items purchased by the customer.
 ...
 * @property null|\FooEventsPOS\Stripe\StripeObject $metadata Set of <a href="https://stripe.com/docs/api/metadata">key-value pairs</a> that you can attach to an object. This can be useful for storing additional information about the object in a structured format.
 * @property string $mode The mode of the Checkout Session.
 * @property null|((object{adjustable_quantity: null|(object{enabled: bool, maximum: null|int, minimum: null|int}&\FooEventsPOS\Stripe\StripeObject), price: string, quantity: int}&\FooEventsPOS\Stripe\StripeObject))[] $optional_items The optional items presented to the customer at checkout.
 ...
 * @property null|string|\FooEventsPOS\Stripe\PaymentIntent $payment_intent The ID of the PaymentIntent for Checkout Sessions in <code>payment</code> mode. You can't confirm or cancel the PaymentIntent for a Checkout Session. To cancel, <a href="https://stripe.com/docs/api/checkout/sessions/expire">expire the Checkout Session</a> instead.
 * @property null|string|\FooEventsPOS\Stripe\PaymentLink $payment_link The ID of the Payment Link that created this Session.
 ...
 * @property null|(object{id: string, parent: null|string}&\FooEventsPOS\Stripe\StripeObject) $payment_method_configuration_details Information about the payment method configuration used for this Checkout session if using dynamic payment methods.
 * @property null|(object{acss_debit?: (object{currency?: string, mandate_options?: (object{custom_mandate_url?: string, default_for?: string[], interval_description: null|string, payment_schedule: null|string, transaction_type: null|string}&\FooEventsPOS\Stripe\StripeObject), setup_future_usage?: string, target_date?: string, verification_method?: string}&\FooEventsPOS\Stripe\StripeObject), affirm?: (object{setup_future_usage?: string}&\FooEventsPOS\Stripe\StripeObject), afterpay_clearpay?: (object{setup_future_usage?: string}&\FooEventsPOS\Stripe\StripeObject), alipay?: (object{setup_future_usage?: string}&\FooEventsPOS\Stripe\StripeObject), amazon_pay?: (object{setup_future_usage?: string}&\FooEventsPOS\Stripe\StripeObject), au_becs_debit?: (object{setup_future_usage?: string, target_date?: string}&\FooEventsPOS\Stripe\StripeObject), bacs_debit?: (object{mandate_options?: (object{reference_prefix?: string}&\FooEventsPOS\Stripe\StripeObject), setup_future_usage?: string, target_date?: string}&\FooEventsPOS\Stripe\StripeObject), bancontact?: (object{setup_future_usage?: string}&\FooEventsPOS\Stripe\StripeObject), boleto?: (object{expires_after_days: int, setup_future_usage?: string}&\FooEventsPOS\Stripe\StripeObject), card?: (object{installments?: (object{enabled?: bool}&\FooEventsPOS\Stripe\StripeObject), request_extended_authorization?: string, request_incremental_authorization?: string, request_multicapture?: string, request_overcapture?: string, request_three_d_secure: string, restrictions?: (object{brands_blocked?: string[]}&\FooEventsPOS\Stripe\StripeObject), setup_future_usage?: string, statement_descriptor_suffix_kana?: string, statement_descriptor_suffix_kanji?: string}&\FooEventsPOS\Stripe\StripeObject), cashapp?: (object{setup_future_usage?: string}&\FooEventsPOS\Stripe\StripeObject), customer_balance?: (object{bank_transfer?: (object{eu_bank_transfer?: (object{country: string}&\FooEventsPOS\Stripe\StripeObject), requested_address_types?: string[], type: null|string}&\FooEventsPOS\Stripe\StripeObject), funding_type: null|string, setup_future_usage?: string}&\FooEventsPOS\Stripe\StripeObject), eps?: (object{setup_future_usage?: string}&\FooEventsPOS\Stripe\StripeObject), fpx?: (object{setup_future_usage?: string}&\FooEventsPOS\Stripe\StripeObject), giropay?: (object{setup_future_usage?: string}&\FooEventsPOS\Stripe\StripeObject), grabpay?: (object{setup_future_usage?: string}&\FooEventsPOS\Stripe\StripeObject), ideal?: (object{setup_future_usage?: string}&\FooEventsPOS\Stripe\StripeObject), kakao_pay?: (object{capture_method?: string, setup_future_usage?: string}&\FooEventsPOS\Stripe\StripeObject), klarna?: (object{setup_future_usage?: string}&\FooEventsPOS\Stripe\StripeObject), konbini?: (object{expires_after_days: null|int, setup_future_usage?: string}&\FooEventsPOS\Stripe\StripeObject), kr_card?: (object{capture_method?: string, setup_future_usage?: string}&\FooEventsPOS\Stripe\StripeObject), link?: (object{setup_future_usage?: string}&\FooEventsPOS\Stripe\StripeObject), mobilepay?: (object{setup_future_usage?: string}&\FooEventsPOS\Stripe\StripeObject), multibanco?: (object{setup_future_usage?: string}&\FooEventsPOS\Stripe\StripeObject), naver_pay?: (object{capture_method?: string, setup_future_usage?: string}&\FooEventsPOS\Stripe\StripeObject), oxxo?: (object{expires_after_days: int, setup_future_usage?: string}&\FooEventsPOS\Stripe\StripeObject), p24?: (object{setup_future_usage?: string}&\FooEventsPOS\Stripe\StripeObject), payco?: (object{capture_method?: string}&\FooEventsPOS\Stripe\StripeObject), paynow?: (object{setup_future_usage?: string}&\FooEventsPOS\Stripe\StripeObject), paypal?: (object{capture_method?: string, preferred_locale: null|string, reference: null|string, setup_future_usage?: string}&\FooEventsPOS\Stripe\StripeObject), pix?: (object{expires_after_seconds: null|int, setup_future_usage?: string}&\FooEventsPOS\Stripe\StripeObject), revolut_pay?: (object{setup_future_usage?: string}&\FooEventsPOS\Stripe\StripeObject), samsung_pay?: (object{capture_method?: string}&\FooEventsPOS\Stripe\StripeObject), sepa_debit?: (object{mandate_options?: (object{reference_prefix?: string}&\FooEventsPOS\Stripe\StripeObject), setup_future_usage?: string, target_date?: string}&\FooEventsPOS\Stripe\StripeObject), sofort?: (object{setup_future_usage?: string}&\FooEventsPOS\Stripe\StripeObject), swish?: (object{reference: null|string}&\FooEventsPOS\Stripe\StripeObject), us_bank_account?: (object{financial_connections?: (object{filters?: (object{account_subcategories?: string[]}&\FooEventsPOS\Stripe\StripeObject), permissions?: string[], prefetch: null|string[], return_url?: string}&\FooEventsPOS\Stripe\StripeObject), setup_future_usage?: string, target_date?: string, verification_method?: string}&\FooEventsPOS\Stripe\StripeObject)}&\FooEventsPOS\Stripe\StripeObject) $payment_method_options Payment-method-specific configuration for the PaymentIntent or SetupIntent of this CheckoutSession.
 ...
 * @property null|(object{update_shipping_details: null|string}&\FooEventsPOS\Stripe\StripeObject) $permissions <p>This property is used to set up permissions for various actions (e.g., update) on the CheckoutSession object.</p><p>For specific permissions, please refer to their dedicated subsections, such as <code>permissions.update_shipping_details</code>.</p>
 * @property null|(object{enabled: bool}&\FooEventsPOS\Stripe\StripeObject) $phone_number_collection
 * @property null|(object{presentment_amount: int, presentment_currency: string}&\FooEventsPOS\Stripe\StripeObject) $presentment_details
 ...
 * @property null|(object{allow_redisplay_filters: null|string[], payment_method_remove: null|string, payment_method_save: null|string}&\FooEventsPOS\Stripe\StripeObject) $saved_payment_method_options Controls saved payment method settings for the session. Only available in <code>payment</code> and <code>subscription</code> mode.
 * @property null|string|\FooEventsPOS\Stripe\SetupIntent $setup_intent The ID of the SetupIntent for Checkout Sessions in <code>setup</code> mode. You can't confirm or cancel the SetupIntent for a Checkout Session. To cancel, <a href="https://stripe.com/docs/api/checkout/sessions/expire">expire the Checkout Session</a> instead.
 * @property null|(object{allowed_countries: string[]}&\FooEventsPOS\Stripe\StripeObject) $shipping_address_collection When set, provides configuration for Checkout to collect a shipping address from a customer.
 * @property null|(object{amount_subtotal: int, amount_tax: int, amount_total: int, shipping_rate: null|string|\FooEventsPOS\Stripe\ShippingRate, taxes?: ((object{amount: int, rate: \FooEventsPOS\Stripe\TaxRate, taxability_reason: null|string, taxable_amount: null|int}&\FooEventsPOS\Stripe\StripeObject))[]}&\FooEventsPOS\Stripe\StripeObject) $shipping_cost The details of the customer cost of shipping, including the customer chosen ShippingRate.
 * @property ((object{shipping_amount: int, shipping_rate: string|\FooEventsPOS\Stripe\ShippingRate}&\FooEventsPOS\Stripe\StripeObject))[] $shipping_options The shipping rate options applied to this Session.
 ...
 * @property null|string|\FooEventsPOS\Stripe\Subscription $subscription The ID of the <a href="https://stripe.com/docs/api/subscriptions">Subscription</a> for Checkout Sessions in <code>subscription</code> mode.
 ...
 * @property null|(object{enabled: bool, required: string}&\FooEventsPOS\Stripe\StripeObject) $tax_id_collection
 * @property null|(object{amount_discount: int, amount_shipping: null|int, amount_tax: int, breakdown?: (object{discounts: (object{amount: int, discount: \FooEventsPOS\Stripe\Discount}&\FooEventsPOS\Stripe\StripeObject)[], taxes: ((object{amount: int, rate: \FooEventsPOS\Stripe\TaxRate, taxability_reason: null|string, taxable_amount: null|int}&\FooEventsPOS\Stripe\StripeObject))[]}&\FooEventsPOS\Stripe\StripeObject)}&\FooEventsPOS\Stripe\StripeObject) $total_details Tax and discount details for the computed total amount.
 ...
 * @property null|(object{link?: (object{display?: string}&\FooEventsPOS\Stripe\StripeObject)}&\FooEventsPOS\Stripe\StripeObject) $wallet_options Wallet-specific configuration for this Checkout Session.
 */
class Session extends \FooEventsPOS\Stripe\ApiResource
{
    const OBJECT_NAME = 'checkout.session';

    use \FooEventsPOS\Stripe\ApiOperations\Update;
    ...
    public static function create($params = null, $options = null)
    {
        ...
        $obj = \FooEventsPOS\Stripe\Util\Util::convertToStripeObject($response->json, $opts);
     ...
     *
     * @return \FooEventsPOS\Stripe\Collection<Session> of ApiResources
     *
     * @throws \FooEventsPOS\Stripe\Exception\ApiErrorException if the request fails
     */
    public static function all($params = null, $opts = null)
    {
        ...
        return static::_requestPage($url, \FooEventsPOS\Stripe\Collection::class, $params, $opts);
    }
    ...
    {
        $opts = \FooEventsPOS\Stripe\Util\RequestOptions::parse($opts);
     ...
     * @param null|array|string $opts
     *
     * @return \FooEventsPOS\Stripe\Collection<\FooEventsPOS\Stripe\LineItem> list of line items
     *
     * @throws \FooEventsPOS\Stripe\Exception\ApiErrorException if the request fails
     */
