...
namespace FooEventsPOS\Stripe\V2;
 ...
 * @property null|(object{aws_account_id: string, aws_event_source_arn: string, aws_event_source_status: string}&\FooEventsPOS\Stripe\StripeObject) $amazon_eventbridge Amazon EventBridge configuration.
 ...
 * @property null|\FooEventsPOS\Stripe\StripeObject $metadata Metadata.
 ...
 * @property null|(object{disabled: null|(object{reason: string}&\FooEventsPOS\Stripe\StripeObject)}&\FooEventsPOS\Stripe\StripeObject) $status_details Additional information about event destination status.
 * @property string $type Event destination type.
 * @property int $updated Time at which the object was last updated.
 * @property null|(object{signing_secret: null|string, url: null|string}&\FooEventsPOS\Stripe\StripeObject) $webhook_endpoint Webhook endpoint configuration.
 */
class EventDestination extends \FooEventsPOS\Stripe\ApiResource
{
