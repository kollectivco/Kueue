...
namespace FooEventsPOS\Stripe\Reporting;
 ...
 * @property (object{columns?: string[], connected_account?: string, currency?: string, interval_end?: int, interval_start?: int, payout?: string, reporting_category?: string, timezone?: string}&\FooEventsPOS\Stripe\StripeObject) $parameters
 ...
 * @property null|\FooEventsPOS\Stripe\File $result The file object representing the result of the report run (populated when <code>status=succeeded</code>).
 ...
 */
class ReportRun extends \FooEventsPOS\Stripe\ApiResource
{
     ...
     *
     * @return \FooEventsPOS\Stripe\Collection<ReportRun> of ApiResources
     *
     * @throws \FooEventsPOS\Stripe\Exception\ApiErrorException if the request fails
     */
