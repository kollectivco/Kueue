 ...
 */
class Variable_FooEvents_Bookings_Date_MySQL extends AutomateWoo\Variable_Abstract_Datetime {
	 ...
	 */
	protected $name = 'fooevents.bookings_date_mysql';
	...
	public function get_value( $ticket, $parameters, $workflow ) {
		...
		return $this->format_datetime( $ticket['WooCommerceEventsBookingDateMySQLFormat'], $parameters );

	}

}

return 'Variable_FooEvents_Bookings_Date_MySQL';
