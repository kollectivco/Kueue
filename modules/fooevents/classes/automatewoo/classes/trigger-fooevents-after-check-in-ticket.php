...
/**
 * FooEvents trigger after check-in ticket
 */
class Trigger_FooEvents_After_Check_In_Ticket extends AutomateWoo\Trigger {
	...
	public function init() {
		...
		$this->title = __( 'After check-in ticket', 'woocommerce-events' );
	...
	public function register_hooks() {
		...
		add_action( 'fooevents_check_in_ticket', array( $this, 'catch_hooks' ) );
	 ...
	 */
	public function catch_hooks( $checkin_data ) {

		$fooevents = new FooEvents();
		$ticket    = $fooevents->get_ticket_data( $checkin_data[0] );
