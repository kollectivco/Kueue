...
class FooEvents_Express_Check_In_Config {
	 ...
	 * Plugin URL
	 *
	 * @var object $plugin_url plugin URL
	 */
	public $plugin_url;
	...
	public function __construct() {
		...
		$this->plugin_file   = $this->path . 'fooevents-express-check_in.php';
		...
		$this->plugin_data = get_plugin_data( __DIR__ . '/fooevents-express-check_in.php' );
