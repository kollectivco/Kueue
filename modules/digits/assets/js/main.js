jQuery(function () {
    ...
    function merge_billing_field() {
        function dig_wc_merge_field(field_name) {
            ...
            if (bp_wc.length > 0) {
                ...
                if (field_name === "shipping_phone") {
                    bp_wc.attr({'nan': 'digits_shipping_phone', 'name': 'digits_shipping_phone'});
                }
    ...
    if(dig_mdet.enhance_wc_checkout_phonenumber == 1) {
        merge_billing_field();
    }
...
//// Ultimate user
    ...
    function update_username_field($this) {
        ...
        if (!usernameid.attr("nan")) usernameid.attr('name', "mobile_email");
    ...
    if ((jQuery('.woocommerce-checkout').length || jQuery("#checkout").length)) {
        ...
        function digits_checkout_otp_verify_success(countryCode, phoneNumber, csrf, otp, dtype, idToken) {
            ...
            var mobile_field = form.find('input[name="mobile_email"]');
            var billing_phone = form.find('input[name="billing_phone"]');

            if (!mobile_field.length) {
                form.append('<input type="hidden" name="mobile_email" id="username" />');
                form.find('input[name="mobile_email"]').val(phoneNumber);
            }
