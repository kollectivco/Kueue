                                            ...
                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:33px 55px;font-family:arial,helvetica,sans-serif;"
                                                ...
                                                <div class="v-text-align"
                                                    ...
                                                    <p style="line-height: 160%; font-size: 14px;"><span
                                                            ...
                                                            <?php
                                                            esc_attr_e('Welcome to {{sitename}}! Your account has been created successfully.', 'digits');
                                                            echo '<br />';
                                                            esc_attr_e('To set your password, please click the link below:', 'digits');
                                                            ?>
                                                        </span>
                                                    </p>
                                                </div>
                        ...
                        <div class="u-col u-col-100"
                            ...
                            <div style="width: 100% !important;">
                                ...
                                <div style="padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;">
                                    ...
                                    <table id="u_content_button_2" style="font-family:arial,helvetica,sans-serif;"
                                           role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                                        <tbody>
                                        <tr>
                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;"
                                                        ...
                                                        <tr>
                                                            <td class="v-text-align"
                                                                ...
                                                                <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml"
                                                                             ...
                                                                             style="height:73px; v-text-anchor:middle; width:402px;"
                                                                             arcsize="16.5%" strokecolor="#293549"
                                                                             strokeweight="2px" fillcolor="#1c2434">
                                                                    <w:anchorlock/>
                                                                    <center style="color:#ffffff;font-family:arial,helvetica,sans-serif;">
                                                    <![endif]-->
                                                    <span class="v-size-width"
                                                          style="box-sizing: border-box;display: inline-block;font-family:arial,helvetica,sans-serif;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #ffffff; background-color: #1c2434; border-radius: 12px; -webkit-border-radius: 12px; -moz-border-radius: 12px; width:70%; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;border-top-width: 2px; border-top-style: solid; border-top-color: #293549; border-left-width: 2px; border-left-style: solid; border-left-color: #293549; border-right-width: 2px; border-right-style: solid; border-right-color: #293549; border-bottom-width: 2px; border-bottom-style: solid; border-bottom-color: #293549;">
                                  <span style="display:block;padding:20px;line-height:120%;"><span
                                          style="font-size: 28px; line-height: 33.6px;"><strong><span
                                                  style="line-height: 33.6px; font-size: 28px;">{{verify-link}}</span></strong>
                                  </span>
                                  </span>
                                                    </span>
                            ...
                            <div style="width: 100% !important;">
                                ...
                                <div style="padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;">
                                    ...
                                    <table style="font-family:arial,helvetica,sans-serif;" role="presentation"
                                        ...
                                        <tbody>
                                        <tr>
                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:17px;font-family:arial,helvetica,sans-serif;"
                                                align="left">
                                  ...
                                  <span style="display:block;padding:24px 20px;line-height:120%;"><span
                                          style="font-size: 20px; line-height: 24px;"><strong><span
                                                  style="line-height: 24px; font-size: 20px;"><span
                                                      ...
                                                      <?php esc_attr_e('Click here to set password','digits');?>
                                                      </span></span>
                                  </strong>
                                  </span>
                                  </span>
